...
// include: ./build_web/combined_assets.js
...
Module['FS_createPath']("/src/res/images", "1", true, true);
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'index.data2.data';
      var REMOTE_PACKAGE_BASE = 'index.data2.data';
      var REMOTE_PACKAGE_NAME = Module['locateFile'] ? Module['locateFile'](REMOTE_PACKAGE_BASE, '') : REMOTE_PACKAGE_BASE;
      var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
...
Module['FS_createPath']("/src", "res", true, true);
Module['FS_createPath']("/src/res", "images", true, true);
Module['FS_createPath']("/src/res/images", "2", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['FS_createDataFile'](name, null, data, true, true, true);
          ...
          Module['removeRunDependency']('datafile_index.data2.data');
      }
      Module['addRunDependency']('datafile_index.data2.data');
    ...
    loadPackage({"files": [{"filename": "/src/res/images/2/11.png", "start": 0, "end": 6305264}, {"filename": "/src/res/images/2/12.png", "start": 6305264, "end": 12695457}, {"filename": "/src/res/images/2/13.png", "start": 12695457, "end": 17722193}, {"filename": "/src/res/images/2/14.png", "start": 17722193, "end": 23607208}, {"filename": "/src/res/images/2/15.png", "start": 23607208, "end": 29558340}, {"filename": "/src/res/images/2/16.png", "start": 29558340, "end": 32441142}, {"filename": "/src/res/images/2/17.png", "start": 32441142, "end": 38363915}, {"filename": "/src/res/images/2/18.png", "start": 38363915, "end": 51133518}, {"filename": "/src/res/images/2/18a.png", "start": 51133518, "end": 65480745}, {"filename": "/src/res/images/2/19.png", "start": 65480745, "end": 75454506}, {"filename": "/src/res/images/2/19a.png", "start": 75454506, "end": 88997619}], "remote_package_size": 88997619});
...
// end include: ./build_web/combined_assets.js
...
var ASM_CONSTS = {
  107004: () => { if (document.fullscreenElement) return 1; },  
 107050: () => { return Module.canvas.width; },  
 107082: () => { return parseInt(Module.canvas.style.width); },  
 107130: () => { document.exitFullscreen(); },  
 107157: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 107229: () => { if (document.fullscreenElement) return 1; },  
 107275: () => { return Module.canvas.width; },  
 107307: () => { return screen.width; },  
 107332: () => { document.exitFullscreen(); },  
 107359: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 107553: () => { return window.innerWidth; },  
 107579: () => { return window.innerHeight; },  
 107606: () => { if (document.fullscreenElement) return 1; },  
 107652: () => { return Module.canvas.width; },  
 107684: () => { return parseInt(Module.canvas.style.width); },  
 107732: () => { if (document.fullscreenElement) return 1; },  
 107778: () => { return Module.canvas.width; },  
 107810: () => { return screen.width; },  
 107835: () => { return window.innerWidth; },  
 107861: () => { return window.innerHeight; },  
 107888: () => { if (document.fullscreenElement) return 1; },  
 107934: () => { return Module.canvas.width; },  
 107966: () => { return screen.width; },  
 107991: () => { document.exitFullscreen(); },  
 108018: () => { if (document.fullscreenElement) return 1; },  
 108064: () => { return Module.canvas.width; },  
 108096: () => { return parseInt(Module.canvas.style.width); },  
 108144: () => { document.exitFullscreen(); },  
 108171: ($0) => { Module.canvas.style.opacity = $0; },  
 108209: () => { return screen.width; },  
 108234: () => { return screen.height; },  
 108260: () => { return window.screenX; },  
 108287: () => { return window.screenY; },  
 108314: () => { return window.devicePixelRatio; },  
 108350: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 108403: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 108454: () => { Module.canvas.style.cursor = 'none'; },  
 108491: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 108747: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 108798: () => { if (document.pointerLockElement) return 1; },  
 108845: () => { if (document.fullscreenElement) return 1; },  
 108891: () => { return window.innerWidth; },  
 108917: () => { return window.innerHeight; }
};
function js_device_pixel_ratio() { return window.devicePixelRatio || 1; }
function js_window_inner_width() { return window.innerWidth; }
function js_window_inner_height() { return window.innerHeight; }
function js_set_canvas_css_size(w,h) { var c = document.getElementById('canvas'); c.style.width = w + 'px'; c.style.height = h + 'px'; }
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['stbi_image_free'] != 'undefined', 'missing Wasm export: stbi_image_free');
  assert(typeof wasmExports['stbi_load'] != 'undefined', 'missing Wasm export: stbi_load');
  assert(typeof wasmExports['stbi_load_from_memory'] != 'undefined', 'missing Wasm export: stbi_load_from_memory');
  ...
  _stbi_image_free = Module['_stbi_image_free'] = createExportWrapper('stbi_image_free', wasmExports['stbi_image_free'], 1);
  _stbi_load = Module['_stbi_load'] = createExportWrapper('stbi_load', wasmExports['stbi_load'], 5);
  _stbi_load_from_memory = Module['_stbi_load_from_memory'] = createExportWrapper('stbi_load_from_memory', wasmExports['stbi_load_from_memory'], 6);
...
var wasmImports = {
  ...
  /** @export */
  js_device_pixel_ratio,
  /** @export */
  js_set_canvas_css_size,
  /** @export */
  js_window_inner_height,
  /** @export */
  js_window_inner_width
};
